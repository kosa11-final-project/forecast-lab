...
const stages: Stage[] = [
  ...
  },
  {
    ...
    result: "MAE 1.219937 · RMSE 2.045311 · R² 0.652927 · Custom Macro NRMSE 0.259569",
    interpretation: "행 단위 MAE·RMSE·R²는 개선됐지만 Macro NRMSE는 4.28% 악화됐고 E0와 계산 정의도 완전히 같지 않습니다.",
    decision: "최종 승자로 확정하지 않고 시계열 균형 지표와 ablation을 추가 검토합니다.",
    next: "공식 MA Baseline, 상시 0 규칙, Calendar/Lag/Rolling ablation을 수행합니다.",
    columns: [
  ...
  },
  {
    ...
    result: "미실행 · 결과 수치 없음",
    interpretation: "평가 후 E0 및 E1-L과 동일 기준으로 비교합니다.",
    decision: "모든 후속 실험의 추가 비교 기준으로 사용합니다.",
    next: "상시 0 시계열 처리 규칙을 확정합니다.",
